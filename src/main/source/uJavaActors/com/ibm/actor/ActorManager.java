...
public interface ActorManager {
	 ...
	 * 
	 * @param clazz
	 *            class of the akka.actor. must have no argument constructor
	 * @param name
	 *            name to assign to the akka.actor; must be unique for this manager
	 * @return the akka.actor
	 */
	Actor createActor(Class<? extends Actor> clazz, String name);

	/**
	 * Create an akka.actor then start it.
	 * 
	 * @param clazz
	 *            class of the akka.actor. must have no argument constructor
	 * @param name
	...
	/**
	 * Detach an akka.actor. This akka.actor is no longer managed by this manger and will
	...
	/**
	 * Send a message to an akka.actor. The message will be processed at a later time.
	 * 
	 * @param message the message
	 * @param from the source akka.actor; may be null
	 * @param to the target akka.actor
	...
	/**
	 * Send a message to an akka.actor in the category. The message will be processed at a later time.
	 * 
	 * @param message the message
	 * @param from the source akka.actor; may be null
	 * @param category category of the target akka.actor
	 * @return number of actors that accepted the send
	 */
	 ...
	 * 
	 * @param type akka.actor type; all if null
	 * 
