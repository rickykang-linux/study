...
public class CalculatorActor extends UntypedActor {
    ...
    public void onReceive(Object message) {
        ...
        if (message instanceof Op.Add) {
            ...
            System.out.println(threadName+", "+"Calculating " + add.getN1() + " + " + add.getN2());
            ...
            System.out.println(threadName+", "+"Calculating " + subtract.getN1() + " - "
                    + subtract.getN2());
            ...
            System.out.println(threadName+", "+"Calculating " + multiply.getN1() + " * "
                    + multiply.getN2());
            ...
            System.out.println(threadName+", "+"Calculating " + divide.getN1() + " / "
                    + divide.getN2());
